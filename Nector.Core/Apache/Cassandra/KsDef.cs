            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i53 = 0; _i53 < _map52.Count; ++_i53)
                {
                  ...
                  Strategy_options[_key54] = _val55;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      if (Strategy_options != null && __isset.strategy_options) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter59 in Strategy_options.Keys)
          {
            oprot.WriteString(_iter59);
            oprot.WriteString(Strategy_options[_iter59]);
            oprot.WriteMapEnd();
          }
        }
        oprot.WriteFieldEnd();
      ...
      if (Cf_defs != null && __isset.cf_defs) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (CfDef _iter60 in Cf_defs)
          {
            _iter60.Write(oprot);
            oprot.WriteListEnd();
          }
