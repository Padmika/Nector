    ...
    public void Write(TProtocol oprot) {
      ...
      if (Column_metadata != null && __isset.column_metadata) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (ColumnDef _iter49 in Column_metadata)
          {
            _iter49.Write(oprot);
            oprot.WriteListEnd();
          }
      ...
      if (Compaction_strategy_options != null && __isset.compaction_strategy_options) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter50 in Compaction_strategy_options.Keys)
          {
            oprot.WriteString(_iter50);
            oprot.WriteString(Compaction_strategy_options[_iter50]);
            oprot.WriteMapEnd();
          }
        }
        oprot.WriteFieldEnd();
      ...
      if (Compression_options != null && __isset.compression_options) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter51 in Compression_options.Keys)
          {
            oprot.WriteString(_iter51);
            oprot.WriteString(Compression_options[_iter51]);
            oprot.WriteMapEnd();
          }
        }
        oprot.WriteFieldEnd();
