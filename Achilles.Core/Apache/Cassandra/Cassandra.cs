              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    ColumnOrSuperColumn _elem81 = new ColumnOrSuperColumn();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (ColumnOrSuperColumn _iter82 in Success)
              {
                _iter82.Write(oprot);
                oprot.WriteListEnd();
              }
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  for( int _i88 = 0; _i88 < _map87.Count; ++_i88)
                  {
                    ...
                    {
                      _val90 = new List<ColumnOrSuperColumn>();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (byte[] _iter94 in Success.Keys)
              {
                oprot.WriteBinary(_iter94);
                {
                  oprot.WriteListBegin(new TList(TType.Struct, Success[_iter94].Count));
                  foreach (ColumnOrSuperColumn _iter95 in Success[_iter94])
                  {
                    _iter95.Write(oprot);
                    oprot.WriteListEnd();
                  }
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (byte[] _iter104 in Success.Keys)
              {
                oprot.WriteBinary(_iter104);
                oprot.WriteI32(Success[_iter104]);
                oprot.WriteMapEnd();
              }
            }
            oprot.WriteFieldEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    KeySlice _elem107 = new KeySlice();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (KeySlice _iter108 in Success)
              {
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  {
                    byte[] _key115;
                    Dictionary<string, List<Mutation>> _val116;
                    _key115 = iprot.ReadBinary();
                    {
                      _val116 = new Dictionary<string, List<Mutation>>();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Mutation_map != null && __isset.mutation_map) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (byte[] _iter124 in Mutation_map.Keys)
            {
              oprot.WriteBinary(_iter124);
              {
                oprot.WriteMapBegin(new TMap(TType.String, TType.List, Mutation_map[_iter124].Count));
                foreach (string _iter125 in Mutation_map[_iter124].Keys)
                {
                  oprot.WriteString(_iter125);
                  {
                    oprot.WriteListBegin(new TList(TType.Struct, Mutation_map[_iter124][_iter125].Count));
                    foreach (Mutation _iter126 in Mutation_map[_iter124][_iter125])
                    {
          ...
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter134 in Success.Keys)
              {
                ...
                {
                  oprot.WriteListBegin(new TList(TType.String, Success[_iter134].Count));
                  foreach (string _iter135 in Success[_iter134])
                  {
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (KsDef _iter139 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TokenRange _elem142 = new TokenRange();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (TokenRange _iter143 in Success)
              {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter147 in Success)
              {
