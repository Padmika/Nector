    ...
    public void Write(TProtocol oprot) {
      ...
      if (Name_types != null && __isset.name_types) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (byte[] _iter73 in Name_types.Keys)
          {
            oprot.WriteBinary(_iter73);
            oprot.WriteString(Name_types[_iter73]);
            oprot.WriteMapEnd();
          }
        }
        oprot.WriteFieldEnd();
      ...
      if (Value_types != null && __isset.value_types) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (byte[] _iter74 in Value_types.Keys)
          {
            oprot.WriteBinary(_iter74);
            oprot.WriteString(Value_types[_iter74]);
            oprot.WriteMapEnd();
          }
        }
        oprot.WriteFieldEnd();
